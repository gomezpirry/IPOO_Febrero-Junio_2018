...
int main (){
	...
	cout<<"Ingrese el timepo que lleva el trabajador en la empresa: ";cin>>tiempoEmpresa;
	...
	if ((diasTrabajados > 10 )&&(diasTrabajados < 20)){
		...
		cout<<"La cantidad de dias no puede superar el 20"; // Este mensaje es icnoreecto( si puede superar el 20)
	}
